...
import { uiOpenDialogDelete, uiOpenProductModalEdit, uiOpenUserModalEdit } from '../../../actions/ui';
import { useLocation, useNavigate } from 'react-router';
import { activeUser, startLoadUsers } from '../../../actions/users';
import { setActiveBinUser, startLoadBinUsers, userBinStartDeleted, userBinStartEnable } from '../../../actions/Bin';

import {
    Search,
    SearchIconWrapper,
    StyledInputBase,
    styles__binUsersTable
} from '../../../styles/dashboard/tables/styles__binUsersTable';


export const BinUsersDashboardTable = () => {

    const dispatch = useDispatch();
    const navigate = useNavigate();
    const location = useLocation();

    const { binUsers, activeBinUser } = useSelector(state => state.bin);
    const { dashboardBinUsers } = useSelector(state => state.dashboard);
            ...
            <div>
                {
                    (binUsers !== undefined)
                        ?
                        <Box
                            sx={styles__binUsersTable(sm, md, lg, xl)}>
