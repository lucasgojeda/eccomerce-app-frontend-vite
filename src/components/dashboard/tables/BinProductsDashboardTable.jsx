...
import { setActiveBinProduct, productBinStartDeleted, productBinStartEnable, startLoadBinProducts } from '../../../actions/Bin';

import {
    Search,
    SearchIconWrapper,
    StyledInputBase,
    styles__binProductsTable
} from '../../../styles/dashboard/tables/styles__binProductsTable';


export const BinProductsDashboardTable = () => {

    const dispatch = useDispatch();
    const navigate = useNavigate();
    const location = useLocation();

    const { binProducts, activeBinProduct } = useSelector(state => state.bin);
    const { dashboardBinProducts } = useSelector(state => state.dashboard);
    ...
    useEffect(() => {
        ...
        dispatch(startLoadBinProducts(filterBy, orderBy, searchText, pagePath));
            ...
            <div>
                {
                    (binProducts !== undefined)
                        ?
                        <Box
                            sx={styles__binProductsTable(sm, md, lg, xl)}>
