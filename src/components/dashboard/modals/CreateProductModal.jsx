...
import { styles__productModal } from '../../../styles/dashboard/modals/styles__productModal';
...
export const CreateProductModal = () => {
    ...
    const { modalProductAdd } = useSelector(state => state.ui);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (errors.length >= 1) {
                ...
                dispatch(productStartAddNew(data));
    ...
    return (
        ...
        <div>
            ...
            >
                <Container sx={styles__productModal(sm, md, lg, xl)}>
                    <Box
                        component="form"
