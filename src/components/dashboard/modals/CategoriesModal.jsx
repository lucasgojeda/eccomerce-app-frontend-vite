...
import { uiCloseCategoriesModal } from '../../../actions/ui';
import { categoryStartDeleted, categoryStartUpdated, startCreateCategory } from '../../../actions/categories';

import { styles__categoriesModal } from '../../../styles/dashboard/modals/styles__categoriesModal';
...
export const CategoriesModal = () => {
    ...
    const { categoriesModal } = useSelector(state => state.ui);
    ...
    const handleCreateSave = (e) => {
        ...
        dispatch(startCreateCategory(categoryState));
    ...
    const handleDeleteSave = (e) => {
        ...
        dispatch(categoryStartDeleted(categoryState))
    ...
    const handleEditSave = (e) => {
        ...
        dispatch(categoryStartUpdated(categoryState))
    ...
    return (
        ...
        >
            <Container sx={{ border: 'none' }} maxWidth="sm">
                <Box
                    sx={styles__categoriesModal(sm, md, lg, xl)}>
