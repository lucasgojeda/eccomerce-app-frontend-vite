...
export const ProductScreen = () => {
    ...
    const handleAddCart = () => {
        ...
        if(role) {
            dispatch(startUpdatedCart({ id: product[0]._id, name: product[0].name, img: product[0].img }, uid));
        } else {
            navigate('/login');
        }
    }
    ...
    const handleDeleteCart = () => {
        ...
        dispatch(startDeletedCart({ id: product[0]._id, name: product[0].name, img: product[0].img }, uid));
    }
    ...
    const handleMenu = (e) => {
        ...
        dispatch(activeProduct(product[0]));
