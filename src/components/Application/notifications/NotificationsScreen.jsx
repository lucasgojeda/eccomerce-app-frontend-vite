...
export const NotificationsScreen = () => {
    ...
    const { sales_user, notifications } = useSelector(state => state.notifications);
    ...
    const handleSendedButton = (e, notification) => {
        ...
        dispatch(notificationStartUpdated(notification))
    ...
    return (
        <Box sx={styles__notificationsScreen(sm, md, lg, xl)}>
